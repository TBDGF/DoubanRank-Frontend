        ...
        return (
            <div>
                <Table dataSource={this.props.rank} size="middle" pagination={{defaultPageSize: this.props.pageSize,}}>
                    ...
                    <Column title="人数" dataIndex="groupMember" key="groupMember" align="center" responsive={['md','lg']}/>
                    ...
                    <Column title="更新时间" dataIndex="updateTime" key="updateTime" align="center" responsive={['md','lg']} />
                </Table>
            </div>
